...
Require the worker to re-run the project's suites over the reconciled tree before starting a fresh run, because reconciling by content produces a tree no run has validated, whichever step was killed.
