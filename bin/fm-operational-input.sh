...
FM_OPERATIONAL_KINDS='session-start watcher turn-end-guard away-supervisor launch-brief branch-outcome usage-window-reset'
...
Current construction kinds:
  ...
  branch-outcome usage-window-reset
